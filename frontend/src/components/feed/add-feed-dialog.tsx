  ...
  return (
    <>
      <Dialog open={isAddFeedOpen} onOpenChange={setAddFeedOpen}>
        <DialogContent
          className="flex w-full max-w-[480px] flex-col gap-0 overflow-hidden bg-popover p-0"
      ...
      >
        <DialogContent
          className="w-full max-w-[560px] bg-popover p-0"
          showCloseButton={false}
        >
          <DialogHeader className="flex flex-row items-center justify-between border-b px-5 py-4">
            <div>
          ...
          <div className="max-h-[360px] space-y-2 overflow-y-auto p-4">
            {detectedFeeds.map((feed, index) => (
              <button
                ...
                className="w-full rounded-md border bg-background/60 p-3 text-left transition-colors hover:bg-accent/50"
              >
