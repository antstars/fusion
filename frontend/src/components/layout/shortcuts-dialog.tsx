...
export function ShortcutsDialog() {
  ...
  return (
    <Dialog open={isShortcutsOpen} onOpenChange={setShortcutsOpen}>
      <DialogContent className="max-h-[80vh] overflow-y-auto bg-popover sm:max-w-[560px]">
        <DialogHeader>
              ...
              <div className="space-y-2">
                {section.items.map((item) => (
                  <div
                    ...
                    className="flex items-center justify-between gap-4 rounded-md border bg-background/60 px-3 py-2"
                  >
