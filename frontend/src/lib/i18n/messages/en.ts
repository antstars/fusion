export const enMessages = {
  ...
  "settings.retention.days.description": "Delete articles older than this age",
  "settings.retention.days.label": "Article age limit",
  "settings.retention.days.option": "{days} days",
  "settings.retention.days.unlimited": "Unlimited",
  "settings.retention.maxArticles.description":
    "Maximum articles to keep globally; 0 means unlimited",
  "settings.retention.maxArticles.label": "Maximum articles",
  "settings.retention.save": "Save retention",
  "settings.retention.saveFailed": "Failed to save retention settings",
  "settings.retention.saved": "Retention settings saved",
  "settings.retention.savedWithDeleted":
    "Retention settings saved; deleted {count} old articles",
  ...
  "group.toggle": "Toggle group {name}",
  ...
  "article.action.readLater": "Read later",
  "article.action.removeReadLater": "Remove later",
  "article.action.star": "Star",
  "article.action.unstar": "Unstar",
  "article.detail.backTop": "Back to top",
  ...
  "article.filter.readLater": "Read Later",
